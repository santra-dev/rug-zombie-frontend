...
import { useGetZmbeBnbLpPriceBnb } from '../../../../state/tombs/hooks'
...
export const UsdPriceRow: React.FC<LockPriceRowProps> = ({ id, bid, ...props }) => {
  ...
  const zmbeBnbLpPrice = useGetZmbeBnbLpPriceBnb()
      ...
      {v3 ? (
        ...
        <>
          <Flex alignItems="center" justifyContent="space-between" {...props}>
            ...
            <Text fontSize="14px">
              {formatNumber(getBalanceAmount(zmbeBnbLpPrice.times(quarterBid * 3)).toNumber())}
            </Text>
          </Flex>
          <Flex alignItems="center" justifyContent="space-between" {...props}>
